...
var ensureAuthenticated = function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, _a, token, user_id, usersRepository, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = authorizationHeader.split(' '), token = _a[1];
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                user_id = jsonwebtoken_1.verify(token, '9c834d6cbe6f6ecac4e16234adfbb85e').sub;
                usersRepository = new UsersRepository_1.default();
                return [4 /*yield*/, usersRepository.findById(user_id)];
            case 2:
                user = _b.sent();
                if (!user) {
                    throw new AppError_1.default('User does not exists', 401);
                }
                request.user = {
                    id: user_id,
                };
