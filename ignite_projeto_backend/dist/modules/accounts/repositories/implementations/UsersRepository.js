...
var UsersRepository = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            throw new AppError_1.default('User does not found');
                        }
    ...
    UsersRepository.prototype.create = function (_a) {
        var name = _a.name, password = _a.password, email = _a.email, driver_license = _a.driver_license, id = _a.id, avatar = _a.avatar;
        return __awaiter(this, void 0, void 0, function () {
            var user;
