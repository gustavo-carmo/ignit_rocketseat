...
var AuthenticateUserUseCase_1 = __importDefault(require("./AuthenticateUserUseCase"));
var AuthenticateUserController = /** @class */ (function () {
    ...
    AuthenticateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, authenticateUserUseCase, _b, token, user;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = request.body, email = _a.email, password = _a.password;
                        authenticateUserUseCase = tsyringe_1.container.resolve(AuthenticateUserUseCase_1.default);
