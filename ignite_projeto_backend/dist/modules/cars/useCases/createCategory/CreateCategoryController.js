...
var CreateCategoryUseCase_1 = __importDefault(require("./CreateCategoryUseCase"));
var CreateCategoryController = /** @class */ (function () {
    ...
    CreateCategoryController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, description, createCategoryUseCase, category;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, description = _a.description;
                        createCategoryUseCase = tsyringe_1.container.resolve(CreateCategoryUseCase_1.default);
